...
{block name=title}eBime - Modification Profil{/block}
...
{block name=body}
    <br/><br/>
    <form method="POST" action="apercuProfil.php?do=update&profil={$profilID}">
    <table>
        <tr>
            <td>Nom : </td>
            <td><input type="text" name="lastname" value="{$profil.lastName}"/></td>
        </tr>
        <tr>
            <td>Prénom : </td>
            <td><input type="text" name="firstname" value="{$profil.firstName}"/></td>
        </tr>
        <tr>
            <td>Date de naissance : </td>
            <td><input type="text" name="birth" value="{$profil.birth}"/></td>
        </tr>
        <tr>
            <td>Sexe : </td>
        ...
        <tr>
            <td>Surnom : </td>
            <td><input type="text" name="nickname" value="{$profil.nickName}"/></td>
        </tr>
        <tr>
            <td>Email : </td>
            <td><input type="text" name="email" value="{$profil.email}"/></td>
        </tr>
        <tr>
            <td>Num téléphone : </td>
            <td><input type="text" name="phone" value="{$profil.phone}"/></td>
        </tr>
    </table>
    <br/><br/>
